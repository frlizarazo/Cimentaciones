%% Parcial 2 semestre pasado
%-------------------------------------------------------------------------
% Franklin Andrés Lizarazo Muñoz
% Estefania Lopez Perez
%-------------------------------------------------------------------------
%
...
B     = 2.80;       % m     - Ancho fundación
L     = 19.60;      % m     - Largo fundación
Df    = 1.00;       % m     - Profundidad de desplante
gamma = 20.30;      % kN/m3 - Peso especifico del suelo
q_    = 286;        % kN/m2 - Carga bruta
t     = 63;         % años  - Tiempo de asentamiento

dz1 = 1.050;        % m     - Espesor estrato 1
Es1 = 10300;        % kN/m2 - Modulo elasticidad 1

dz2 = 4.200;        % m     - Espesor estrato 2
Es2 = 15702;        % kN/m2 - Modulo elasticidad 2

dz3 = 4.750;        % m     - Espesor estrato 3
Es3 = 13504;        % kN/m2 - Modulo elasticidad 3
...
qzero     = 256;               % kN/m2 - Esfuerzo de contacto
B         = 3;                 % m     - Ancho de la zapata
L         = 18;                % m     - Largo de la zapata
Df        = 1;                 % m     - Profundidad de desplante
gammaw    = 9.81;              % kN/m3 - Peso especifico del agua

Hs        = 4;                 % m     - Espesor estrato arena
gammas    = 16;                % kN/m3 - Peso especifico de la arena
gammassat = 17;                % kN/m3 - Peso especifico de la arena saturada

Hc        = 3;                 % m     - Espesor estrato arcilla
gammacsat = 15;                % kN/m3 - Peso especifico de la arcilla saturada

e0        = 2.50;              %       - Relación de vacíos
Ccc       = 0.25;              %       - Coeficiente de compresion de campo
Cs        = 0.05;              %       - Cueficiente de recompresion

Sigma_c   = 90;                % kN/m2 - Esfuerzo de preconsolidación
naf       = 1.15;              % m     - Altura nivel freatico
A         = 0.6;               %       - Skepton
